...
\affiliation[inst1]{organization={[AFFILIATION], [UNIVERSITY]},
            city={[CITY]},
            country={[COUNTRY]}}
...
\caption{Held-out evaluation, 300 questions, seven systems. Latency is mean end-to-end wall clock. The EHR-contradiction rate reported in earlier versions of this work is withdrawn as invalid (Section~\ref{sec:halluc-validation}).}
\label{tab:main}
\begin{tabular}{lrrrrrrr}
\toprule
System & BLEU & ROUGE-L & BERTScore~F1 & Unsupported & Latency~(ms) & Prompt tok. & KG facts \\
\midrule
T                            & 0.1588 & 0.2676 & 0.7937 & 0.5813 & 2209.6 & 1922 & 0.00 \\
T+E (always-T+E)             & 0.6859 & 0.7965 & 0.9553 & 0.3244 & 3341.3 & 2118 & 0.00 \\
T+E+K (always-on hybrid)     & 0.7481 & 0.8630 & \textbf{0.9708} & \textbf{0.1832} & 7527.7 & 2367 & 8.88 \\
...
Oracle (upper bound)         & 0.7497 & 0.8727 & 0.9708 & 0.2552 & 3961.7 & 2119 & 1.66 \\
\bottomrule
\end{tabular}
\end{table}
