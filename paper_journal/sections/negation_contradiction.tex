% =====================================================================
% DRAFT SECTION — negation-contradiction metric validation
% =====================================================================
% Written 2026-08-17. NOT yet inserted into paper/main.tex.
%
% WHERE THIS GOES
%   Replaces the current treatment of "EHR-contradiction" in the evaluation
%   section, and should sit after the main results table.
%
% CHANGES THIS REQUIRES ELSEWHERE IN main.tex (not made here):
%   1. Main results table: the "EHR-Contra." column is withdrawn. Per the
%      Option-A reporting decision, no corrected rate replaces it in the main
%      table; the column is removed and this section explains why. If a
%      reviewer asks for numbers, the per-type rates are in the artifacts.
%   2. Abstract: the hallucination claim must no longer cite an
%      EHR-contradiction rate. The defensible sentence is that the router is
%      statistically indistinguishable from always-on hybrid on quality and
%      significantly worse on grounding (unsupported-rate), with the
%      contradiction heuristic withdrawn as invalid.
%   3. Limitations: keep the mode-T n/a statement; add the Type-2 scope note
%      and the "no abnormal" qualifier artifact from this section.
%   4. H1 criterion 3: the sub-claim "EHR-contradiction is effectively tied
%      (0.0233 vs 0.0247, p = 0.157)" MUST be deleted. It compared two
%      quantities that are both artifacts. The unsupported-rate half of
%      criterion 3 stands and is now human-validated.
%
% All numbers below are traceable to experiments/results/annotation{,_v2,_v3}/
% and RESEARCH_LOG.md entries dated 2026-08-16 and 2026-08-17.
% =====================================================================
